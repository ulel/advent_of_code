...
def calculate_total_fuel(masses, fuel_func=calculate_fuel):
    return sum(map(fuel_func, masses))
...
def calculate_correct_total_fuel(masses):
    return calculate_total_fuel(masses, fuel_func=calculate_total_module_fuel)


def main():
    print(f"part 01: {calculate_total_fuel(aoc_01_input.get_input())}")
    print(f"part 02: {calculate_correct_total_fuel(aoc_01_input.get_input())}")
