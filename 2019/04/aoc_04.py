...
def is_valid_password_part_2(password: int) -> bool:
    password_string = str(password)
    ...
    for digit in password_string[1:]:
        ...
        if digit == previous_digit and not (potential_pair or larger_group):
            potential_pair = True
        elif potential_pair and digit == previous_digit:
            potential_pair = False
            larger_group = True
        elif potential_pair and digit != previous_digit:
            found_pair = True
            potential_pair = False
        elif larger_group and digit != previous_digit:
            larger_group = False
    ...
    return found_pair or potential_pair
...
def main():
    ...
    valid_part_2 = [
        password for password in valid_part_1 if is_valid_password_part_2(password)
    ]

    print(f"part 1: {len(valid_part_1)}")
    print(f"part 2: {len(valid_part_2)}")
